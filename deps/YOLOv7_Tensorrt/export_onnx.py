...
sys.path.append('/workspace/yolov7')  # to run '$ python *.py' files in subdirectories
...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-obj', type=int, default=300, help='topk')
    parser.add_argument('--iou-thres', type=float, default=0.65, help='nms iou threshold')
    parser.add_argument('--score-thres', type=float, default=0.001, help='nms score threshold')
